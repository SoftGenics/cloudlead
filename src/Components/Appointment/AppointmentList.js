...
const AppointmentList = () => {
    ...
    useEffect(() => {
      ...
      const fetchPosts = async () =>{
        const res = await axios.get("https://backend.softgenics.in/api/allAppointment");
        SetPost(res.data)
      }
      fetchPosts();
    });
  ...
  return (
    <div>
      ...
      <NavbarMenu />
        ...
        <h1 className='text-center mb-3'>List of all<span style={{color:'#3bc0fd'}}> Appointments</span></h1>
