...
function RecentReport() {
    ...
    useEffect(() => {
      ...
      const fetchPosts = async () =>{
        const res = await axios.get("https://backend.softgenics.in/api/todayreport");
        SetPost(res.data)
      }
      fetchPosts();
    });
  ...
  return (
    ...
    <Container className='mt-5'>
      <h1 className='text-center mb-3'>Recently Added<span style={{color:'#3bc0fd'}}> Report</span></h1>
